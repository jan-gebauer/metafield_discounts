...
import { getProducts, getProductsLastPage } from "graphql/productQueries";
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  if (firstNumber != null && lastNumber != null || lastNumber != null) {
    response = await getProducts({ admin, nextCursorParam });
  } else if (firstNumber != null) {
    response = await getProductsLastPage({ admin, previousCursorParam });
  }
