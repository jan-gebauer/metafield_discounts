/*
  ...
  - You are about to drop the column `discount_id` on the `Metafield` table. All the data in the column will be lost.
...
CREATE TABLE "new_Metafield" (
    ...
    CONSTRAINT "Metafield_discountId_fkey" FOREIGN KEY ("discountId") REFERENCES "Discount" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
